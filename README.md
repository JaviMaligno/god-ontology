...
- [Treatise outline](writing/treatise-outline.md): an English-language structure that separates motivation from ontology; first-pass prose now exists for every Part in [writing/treatise/](writing/treatise/), from [Parts I–II](writing/treatise/parts-i-ii-motivation-and-method.md) to [Part VIII](writing/treatise/part-viii-comparison-and-evaluation.md); the appendices are at outline.
