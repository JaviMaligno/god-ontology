...
| CH15 | Can a $G$ whose established profile is good-oriented toward sourcehood and relation permit created suffering without misfit toward conscious valence; what would close the P-gap? | divine goodness, providence, intervention, agency ecology, privation, creation reasons | `tested` (partial) |
| CH16 | Under what conditions is an experience of $G$ veridical of standing presence or of exercised regard rather than non-veridical, and what defeats it? | personal availability, experiential access, epistemology of the fourth layer, intervention typing | `scoped` |
| CH17 | Does the ontology support an extended bearer horizon — personal continuation — sufficient to cover bearer-level suffering, and what would it require of E+, ACO, the embodied subject, and the privative model? | P-gap closure, personal identity, E+, ACO, embodied agency, hell as privation, divine goodness | `tested` (partial) |
| CH18 | What criterion secures the identity of a post-mortem subject with its embodied predecessor under each open realization model, and can gappy existence of one individual be coherent? | personal continuation, mind–body realization, individuation, divine re-realization, P-gap closure | `tested` (partial) |
| CH19 | How do reductions of diachronic or evaluative authorship by created curators — propaganda, engineered addiction, algorithmic environments, coercive institutions — bear on responsibility by degree, and where is the line between formation and manipulation? | agency ecology, manipulation, responsibility, finite norm construction, moral status | `scoped` |
...
S35–S37 open a question-driven route into the register: plain questions from the accessible track that the ledger cannot answer are recorded as challenges. S36 gives the contingency/ground junction its F2 comparison; S37 earns a good-oriented divine profile toward sourcehood and relation and isolates the P-gap as CH15; S38 tests CH15 partially through permission, policy-level covers, and the bearer-level remainder, and opens CH17 because closure depends on personal continuation. S39 tests CH17 partially: continuation is coherent under every open realization model, within divine power as a further act, empirically undefeated and unsupported, and conditional on $GoodOrient_P(G)$; its identity burden becomes CH18, which waits on the mind–body branch. The track returns to CH12, where S30–S33 already supply the F2 constitution, boundary, and power results; S40 deepens the constitution/production junction. S41 then structures C118: cumulative context control can remove diachronic and evaluative authorship while token autonomy holds, which extends the agency-preservation presumption to the diachronic level and opens CH19 for created-level curation. S42 tests CH18 partially by deriving simple persistence from the agency model. CH16 records the experiential question.
...
S38 supplies that partial result. Cases 1 and 3 receive the policy-level source cover and case 2 the regularity cover; both leave a threshold residue whose arbitrary-threshold reply is recorded as contested. Case 4 is defined as gratuitous suffering. The bearer-level remainder shows that policy-level covers cannot by themselves close the gap for a bearer whose life ends in uncovered suffering, which opens CH17. The challenge remains `tested` rather than `resolved`.

## CH16 — Veridicality of experiential access

S35 distinguishes experience veridical of standing presence, veridical of exercised regard, and non-veridical. The challenge is to specify, beyond that partition, which features of an experience or of the subject's practice bear on veridicality and which defeat it, without making the experiential register either self-authenticating or empty.

Tests should include experiences with known naturalistic triggers, experiences that conflict with established truths, experiences across traditions with incompatible contents, cumulative practice versus isolated episodes, and the difference between an experience of presence and a claimed propositional revelation. The framework must keep C305: no experience is evidence for the architecture.

## CH17 — Personal continuation and bearer horizons

S38 derives that closure of the P-gap for bearers whose lives end in uncovered suffering requires undefeated $P$-fit within a horizon extending beyond the bearer's life. The challenge is whether the ontology can support such a horizon without importing it as a rescue.
...
S39 supplies the partial result: continuation is defined as the numerically same bearer with an undefeated fit horizon anywhere in $\mathfrak R^*$; every open realization model admits it by persistence or re-realization; it is typed as an intervention or further creative act within qualified power iff its identity condition is coherent; empirical base-dependence does not defeat it and nothing supports it; and its only internal support is the conditional from $GoodOrient_P(G)$. Universality and co-production follow if it obtains. The identity criterion is CH18.

## CH18 — Identity across the cessation of the realization base
...
Tests should include: two candidates equally continuous with $B$; a re-realization with partial psychological continuity; persistence of a bearer with no realized capacities; whether $G$'s individuating knowledge (C122) can fix identity or only track it; and whether the bearer-indexed $Fit_*$ can be satisfied by anything less than numerical identity. A negative result leaves C322 conditional on an incoherent consequent and reopens the P-gap.

S42 supplies the partial result. The agency model already entails simple persistence (C343), so no criterion is needed; gappy existence is coherent under E+ (C345); re-realization targets the individual de re while ACO tracks the identity fact (C346); a replica is a distinct unit (C347); and identity is what matters for a source (C348). The reductive realization is disfavored (C349). Open: the choice between persistence and re-realization routes, wholly unrealized existence, and fission at the created level.


## CH19 — Created curation, formation, and responsibility

S41 types manipulation as cumulative a-rational influence that removes evaluative authorship, and funnelling as closure of the profile space, both compatible with token autonomy. The created-level challenge is to say when formation under dependence and constraint (C166) becomes curation, and how reduced diachronic or evaluative authorship bears on responsibility by degree (C38, deferred).

Tests should include: upbringing versus indoctrination; persuasion versus engineered appetite; recommender systems that shape salience; institutions that close profile space while preserving formal choice; agents who later endorse standards installed in them; and agents who break a funnel. The challenge must keep the graded character of C336 and must not infer reduced welfare importance from reduced authorship (CH10).
