...
| Consciousness production and mind–body realization | load-bearing support | comparative F2 accepted | integrate with the identity module | selective F3 | S37's embodied hylomorphic-powers model is accepted; identity of its bearer through change and gaps is now load-bearing |
| Individuation and persistence | cross-cutting trunk support | F1 distinctions plus open $GapIdentity_C$ | develop at F2 next | selective F3 | Controls embodied subjects, conscious episodes, task eligibility, modification/replacement, recreation, fission, self-copy, and *ex deo* |
