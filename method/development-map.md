...
| Personal continuation and bearer horizons | trunk dependency opened by the P-gap | F0 | F1 pass proposed (CH16) | F2 if it becomes the closure of $GoodOrient_P$ | C243; must be consistent with E+, ACO, the embodied subject of S29, and hell-as-privation; may fail, which would leave the P-gap open |
...
The author's brief of 2026-09-02 adds a question-driven track: plain questions from the accessible register that the ledger cannot answer become research items. S30–S33 supplied the first four. S33 structures the P-gap and finds that its closure depends on personal continuation, which is now a trunk dependency and competes with divine constitution for the next session.

1. Treat personal continuation at F1 (CH16): whether the ontology supports an extended bearer horizon sufficient to cover bearer-level suffering, what E+, ACO, the embodied subject of S29, and the privative model of S28 permit or require, and what would follow for the P-gap if it fails.
2. Give divine constitution and material production a joint F2 pass: clarify what “made of,” substance, composition, and substrate mean for $G$, then compare non-material OEC, structured divine substance, *ex deo* continuity, and co-fundamental matter (CH12).
3. Use that result to deepen the OEC/PMC junction without reopening the now-closed general ethical branch.
