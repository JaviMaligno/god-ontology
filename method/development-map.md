...
| Intervention, miracle, and providence | downstream | F2, with the diachronic level added in S40 | hold | F2–F3 if retained | Depends on creation, agency, knowledge, and attributes; C321–C329 extend the model from token acts to lives |
...
| Creation bridge: production and creative reason | trunk-to-creation junction | production F3 after S39; reason F1 | hold and reintegrate into intervention and providence | selective F2–F3 | S30–S31 prefer constitutively disjoint $OEC^+$, type *ex deo* into four levels, accept $PMC_T$, and retain $PMC_U$ as a defeater; S18 supplies the reason profile |
...
| Mind–body realization of agency | lateral support | F1 with local F2 episode model; S41 adds a persistence constraint | defer after S29 and S41 | undecided; F3 only if load-bearing | S07, S22, and S29 prefer unified embodied agency, distinguish preparation from settlement and conscious control, and keep reductive, non-reductive embodied, dual-aspect, hylomorphic, and substance-dualist realizations open |
| Personal continuation and bearer horizons | trunk dependency opened by the P-gap | F2 after S41 | hold; route choice and fission wait on the mind–body branch | F2 if it becomes the closure of $GoodOrient_P$ | C304–C310; coherent under every open realization model, within divine power as a further act, empirically undefeated and unsupported, conditional on $GoodOrient_P(G)$ |
