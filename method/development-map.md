...
| Contingency and necessary ground | trunk | F2 | hold after S31 | F3 | C04, C222–C226; weak explanatory preference, necessitation lemma, and four stopping points now stated; brute contingency and impersonal necessity remain live opponents |
| Necessary agent versus impersonal structure | trunk junction | F2 | hold after S31 | F3 | Preferred C05 retained with its formal core (C225) and identified preferential residue; reopen only for a substantive defeater or final literature pass |
...
| Goodness, reasons, suffering, and responsibility | bounded axiological interface | F1 closed with local F2 repair; S32 adds a good-oriented profile; S33 structures the P-gap | hold; closure of the P-gap depends on CH16 | further F2 only if ontologically load-bearing | S27–S28 supply $\mathcal A_{min}$, decomposed $Fit_*$, due-good privation, epistemically modest sacrifice, positive long-term preference, species continuity, and provisional $G$-grounding; complete longtermist and detailed ethical theories remain optional |
...
| Personal continuation and bearer horizons | trunk dependency opened by the P-gap | F1 | hold after S34; identity criterion (CH17) waits on the mind–body branch | F2 if it becomes the closure of $GoodOrient_P$ | C245–C251; coherent under every open realization model, within divine power as a further act, empirically undefeated and unsupported, conditional on $GoodOrient_P(G)$ |
| Experiential access and the accessible register | fourth evidential layer and exposition | F1 | hold after S30; revise answers when cited items change | F1–F2 (veridicality and defeaters, CH15) | S30; C231–C236; the accessible register is downstream and question-driven |
...
The author's brief of 2026-09-02 adds a question-driven track: plain questions from the accessible register that the ledger cannot answer become research items. S30–S34 supplied the first five. S34 leaves continuation conditional and relocates its remaining burden to the identity criterion, which depends on the deferred mind–body realization. The track therefore returns to the trunk.

1. Give divine constitution and material production a joint F2 pass: clarify what “made of,” substance, composition, and substrate mean for $G$, then compare non-material OEC, structured divine substance, *ex deo* continuity, and co-fundamental matter (CH12).
2. Use that result to deepen the OEC/PMC junction without reopening the now-closed general ethical branch, and note what it implies for the substance of created subjects.
3. Treat the identity criterion for continuation (CH17) once a realization model is selected or the constitution result constrains it; do not settle identity by stipulation.
4. Retain qualified-power blockers, ACO's interpersonal knowledge gap, and cumulative intervention effects on agency as the next trunk candidates.
5. Retain $G$-grounded $Fit_*$ as provisional with the S32 route as its content; test it further only when divine goodness, providence, or another ontological module requires it.
