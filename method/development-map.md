...
The arrows express research dependence, not a single ontological relation. Existing downstream modules remain useful but conditional where their upstream premises are provisional. Since S16 the spine has acquired branches not drawn above: divine constitution and material production (S30–S31, S49) under the necessary agent; the qualified-power hierarchy (S32–S33); goodness → good-orientation → permission and covers → continuation → simple persistence (S27–S28, S46–S48, S51) under later evaluation; the diachronic level of agency (S50) under creaturely agency; and experiential access (S44) under personal availability.
...
| Contingency and necessary ground | trunk | F2 | hold after S45 | F3 | C04, C420–C424; weak explanatory preference, necessitation lemma, and four stopping points now stated; brute contingency and impersonal necessity remain live opponents |
| Necessary agent versus impersonal structure | trunk junction | F2 | hold after S45 | F3 | Preferred C05 retained with its formal core (C423) and identified preferential residue; reopen only for a substantive defeater or final literature pass |
...
| Creation bridge: production and creative reason | trunk-to-creation junction | production F3 after S49; reason F2 after S54 | hold and reintegrate into intervention and providence | selective F2–F3 | S30–S31 prefer constitutively disjoint $OEC^+$, type *ex deo* into four levels, accept $PMC_T$, and retain $PMC_U$ as a defeater; S18 supplies the reason profile |
| Goodness, reasons, suffering, and responsibility | bounded axiological interface | F1 closed with local F2 repair; S46 adds a good-oriented profile; S47 structures the P-gap | hold; closure of the P-gap depends on CH20 | further F2 only if ontologically load-bearing | S27–S28 supply $\mathcal A_{min}$, decomposed $Fit_*$, due-good privation, epistemically modest sacrifice, positive long-term preference, species continuity, and provisional $G$-grounding; complete longtermist and detailed ethical theories remain optional |
| Consciousness production and mind–body realization | load-bearing support | comparative F2 accepted | hold after CH16 | selective F3 | S37's embodied hylomorphic-powers model is accepted; dual aspect, causal non-competition, onset, and the person boundary remain selective F3 burdens; S51's simple persistence (C469) and S53's identity partition (C477–C483) are consistent with it |
| Identity of subjects and of $G$ | cross-cutting | F2 | hold after S53 | F3 with the mind–body branch | C477–C483; numerical identity, individuation, persistence, and identification separated and scoped by kind |
| Personal continuation and bearer horizons | trunk dependency opened by the P-gap | F2 after S51 | hold; route choice and fission wait on the mind–body branch | F2 if it becomes the closure of $GoodOrient_P$ | C443–C449; coherent under every open realization model, within divine power as a further act, empirically undefeated and unsupported, conditional on $GoodOrient_P(G)$ |
| Experiential access and the accessible register | fourth evidential layer and exposition | F1 | hold after S44; revise answers when cited items change | F1–F2 (veridicality and defeaters, CH19) | S44; C429–C434; the accessible register is downstream and question-driven |
...
11. Creative reason: completed at F2 in S54 (C484–C490); the P-gap is relocated to the absence of a P-directed reason, with two candidate routes open (C489).
12. Modal basis: completed at F2 in S55 (C491–C497); B1 supplied, B2 reduced to $MUNA$, creative plenitude conditional on preferred premises. S56 answers the author's question on other universes (C498–C503). S57 consolidates Parts III–IV into first-pass prose without finding an inconsistency, S59 does the same for Part V, S61 for Part VI, and S63 for Part VII. S62 closes the self-consistency of responsive interventions with a well-foundedness condition (C513–C516) and shows it is not absorbed by $HI_G$. S60 records the author's first review of the accessible answers (eleven revisions, two questions split, two added) and reconciles the branch with S40–S42 (C510–C511). S58 reconciles the two tracks after the merge of S35–S38 (C504–C508); after the merge of S39, $MUNA$ is merged into the author's MUU and the creative-plenitude theorem gains the directness premise B2d (C509). Next, proposed under C324 rather than promoted: the remaining open trunk items (the directness test C366, the P-reason routes of C489, CH14's content and reference parts) or the consolidation of Part VI.
13. CH03 is closed at local F2 in S34; hold the $\langle ACO_P,MKO,ASA\rangle$ profile and revisit phenomenal sharing only if another module requires it. S53 defines identity and records $ASA$ as $G$'s mode of identification.
14. CH14 is integrated by the author's S38 as a test of $Poss_C^{ind}$; S55's definition is reconciled with it in S58 (C505): $Adm_C$ is canonical, model existence explicit, the $E_G$ clause moved to B4.
15. Cumulative intervention effects on agency: the author's S35 (C297–C308) is canonical; S50 (C460–C468) adds funnelling, evaluative authorship, and the diachronic presumption, reconciled in S58 (C504) as refinements; created-level responsibility is CH22.
16. Identity across cessation (CH21): completed at F2 in S51 by deriving simple persistence from the agency model; consistent with the accepted embodied subject of S37 and the open person boundary of C320.
17. Hold the qualified-power hierarchy at F2; S49 completes the constitution/production F3 pass (C450–C459), leaving the range bridge, the operation of an existential power beneath its exercise, and $NI$-based strict *ex deo* as selective F3 triggers.
18. Retain $G$-grounded $Fit_*$ as provisional with the S46 route as its content; test it further only when divine goodness, providence, or another ontological module requires it.
