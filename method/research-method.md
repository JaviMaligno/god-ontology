...
68. Remaining on the branch: the provenance pass (needs online access) and the author's second passes. Nothing is promoted (C324); the trunk's next question is the author's.
