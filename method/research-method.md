...
69. Remaining on the branch: the provenance pass (the author, locally, with `research/provenance-checklist.md`) and the author's second passes. Nothing is promoted (C324).
