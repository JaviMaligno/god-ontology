...
| Good-oriented profile toward sourcehood and relation | Earned in the architecture | `preferred`; agency-oriented creation, the agency-preservation presumption, universal personal availability, and truth-tracking ACO are instances of $Fit_*$ toward $S$ and $R$; C227–C230 | S32–S33 | Hold at F1 with local F2 notation; S33 structures the P-gap through permission, policy-level covers, and the bearer-level remainder; closure depends on personal continuation (CH16) |
