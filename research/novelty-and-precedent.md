...
No novelty attaches to those positions or to the distinctions among modification, replacement, corruption, and annihilation. The potentially distinctive synthesis is $GSDA+CCS_G$: ordinary created causes supply proximate derivative production, $G$ retains source-neutral substitutive capacity, free-act identity remains indexed to the creaturely settler, and annihilation is withheld until atemporal grounding receives an independent termination account.
